@if(isset($otherDetails) && count($otherDetails) > 0)
  ...
  @foreach($otherDetails as $orderProduct)
    <div class="row">
        ...
        <div class="col-xs-8 col-lg-8 col-md-12 col-sm-12">
            <div class="quantity-content">               
                ...
                <div class="form-group">
                    <label>@lang('quickadmin.order.fields.height')</label>
                ...
                <div class="form-group">
                    <label>@lang('quickadmin.order.fields.width')</label>
                ...
                <div class="form-group">
                    <label>@lang('quickadmin.order.fields.length')</label>
        ...
        <div class="col-xs-3 col-lg-3 col-md-3  col-sm-12">
            <div class="form-group">
                <label>@lang('quickadmin.order.fields.number_of_item')</label>
        ...
        <div class="col-xs-1 col-lg-1 col-md-1  col-sm-1 mt-10">
            <div class="form-group">
