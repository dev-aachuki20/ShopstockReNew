...
class PermissionRoleTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $adminpermissionid= Permission::whereIn('name',['profile_access', 'profile_edit', 'user_change_password' , 'customer_management_access', 'customer_access','customer_create' ,'customer_edit','customer_print','transaction_management_access','estimate_access','estimate_show','estimate_ledger_print','estimate_statement_print','estimate_print'])->pluck('id')->toArray();
